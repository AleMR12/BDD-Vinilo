...
if (isset($_POST['nombre_artistico']) && isset($_POST['nombre']) && isset($_POST['apellido1']) && isset($_POST['apellido2']) && isset($_POST['descripcion'])) {
    ...
    $sql = "INSERT INTO artistas (Nombre_Artistico, Nombre, Apellido1, Apellido2, Descripción, Foto) VALUES ('$nombre_artistico', '$nombre', '$apellido1', '$apellido2', '$descripcion', '$carpeta_destino$nombre_imagen')";
